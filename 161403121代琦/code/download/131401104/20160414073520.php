...
<body>
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr>
			<td class="title">PHPFileList文件下载列表</td>
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="1">
		<tr>
			...
			if($dir > $basedir) echo "<a href=\"?dir=". $predir ."\">上级目录</a>";
			?>
			</td>
		</tr>
		<?php
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="1">
		...
		while ($file=@readdir($dirs)) {
			...
			if($a=="0"){
				...
				echo "<td>$lastsave</td>\n";
				echo "<td>$size KB</td>\n";
				echo "<td><a href=\"?downfile=".($dir > $basedir ? str_replace($basedir . "/",'',$dir . "/") : '').urlencode($file)."\">下载</a></td>\n";
				echo "</tr>\n";
			}
		}
		@closedir($dirs);
