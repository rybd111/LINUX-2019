...
<?php
  ...
  if ($admin_account<>$admin_account0)  {
    $sql="select S_id from student where S_id='$admin_account'";
  ...
  $sql="update student set S_id='$admin_account',S_name='$admin_name',S_passwd='$admin_passwd',S_depart='$admin_bumen',S_sex='$admin_sex' where S_id='$admin_account0'";
